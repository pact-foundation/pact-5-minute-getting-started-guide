...
echo "Type intro - to run consumer tests and publish pacts"
echo "consumer - to run consumer tests"
echo "provider - to run provider tests"
echo "publish - to publish the pacts to a Pactflow Broker"
echo "pacts - to show the pacts generated by the consumer"
echo "full - to run the full flow (consumer -> publish -> provider)"
alias intro="npm run intro"
alias consumer="npm run test:consumer"
alias provider="npm run test:provider"
alias publish="npm run pact:publish"
alias pacts="npm run pact:show"
alias full="npm run all"
npm run intro